...
const FlipCard = ({ image, title, description, subtitle, rotate = "y", className, ...props }) => {
  ...
  return (
    <div className={cn("group h-72 w-56 [perspective:1000px]", className)} {...props} onClick={handleFlip}>
      <div
        className={cn(
