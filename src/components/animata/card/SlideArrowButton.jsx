...
import { ArrowRight } from "lucide-react"; // Ensure this icon library is available
...
const SlideArrowButton = ({
  ...
  return (
    <button
      className={`group relative rounded-full border border-white bg-white p-2 text-sm font-semibold ${className}`}
      {...props}
    >
      <div
