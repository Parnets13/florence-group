...
import physiotherapy from './data/PhysiotherapyCourses.jsx';
import DoubleUnderline from './animata/card/DoubleUnderline.jsx';

const Physiotherapy = () => {
    const [selectedCourse, setSelectedCourse] = useState(physiotherapy[0]); // Set the initial state to the first course
    ...
    return (
        <div className='px-[3vw] '>
            ...
            <div className='my-10 flex flex-col lg:flex-row gap-10'>
                <div
                    className="w-full lg:w-[25%] rounded-md lg:sticky top-[100px] z-0 h-[400px] flex flex-col space-y-3 bg-[#89216b] justify-center items-center"
                >
                    {physiotherapy.map((item, index) => (
                        <div key={index} className="w-3/4 text-center">
                            <h1
